...
public
class AxisModelDuration extends AxisModel

{
    ...
    //
    // Some of the code looks appears to support horizontal or vertical
    // axes, however there are places where we currently assume the axis
    // is vertical - we eventually may look into this, but it's not all
    ...
    AxisModelDuration(DataAxis axis) {
